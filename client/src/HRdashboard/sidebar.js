...
const Employeedashboard = ({ isCollapsed, setIsCollapsed }) => {
  const handleLogout = () => {
  ...
  const navItems = [
    ...
    //*****************************Employees****************************************/
    {
      ...
      links: [{ label: "Employees", path: "/dashboard/employee" }],
    },
    //********************************Attendance***********************************/

    {
      ...
      links: [{ label: "Employees", path: "/dashboard/employee/Attendance" }],
    },
...

    {
      ...
      links: [{ label: "Employees", path: "/dashboard/employee/Rfid" }],
    },
    ...
    },
    {
      ...
      links: [{ label: "Device", path: "/dashboard/employee/Device" }],
    },
    {
      label: "Zones",
      icon: (
      ...
      links: [{ label: "Zones", path: "/dashboard/employee/zones" }],
    },
  ];
