...
const ContractorDashboard = () => {
  ...
  <div className="col-span-2 space-y-4">
    {/* <!-- Row 1: Today’s Attendance & Assigned Section --> */}
    <div className="grid grid-cols-2 gap-4">
      ...
      <div className="bg-white dashboard-crm-box-shadow p-6 rounded-lg">
        ...
        <h2 className="text-2xl font-bold mt-2">Present</h2>
        <p className="text-gray-400 text-sm">Check-in: 09:00 AM | Check-out: Pending</p>
      </div>
      ...
      <div className="bg-white dashboard-crm-box-shadow p-6 rounded-lg">
        <p className="text-gray-500 flex items-center space-x-2">
          ...
          <span className="font-semibold">Assigned Section</span>
        </p>
        <h2 className="text-2xl font-bold mt-2">Assembly</h2>
        <p className="text-gray-400 text-sm">Supervisor: Mr. Sharma</p>
      </div>
    </div>

    {/* <!-- Row 2: Work Hours & Notifications --> */}
    <div className="grid grid-cols-2 gap-4">
      {/* <!-- Work Hours Card --> */}
      <div className="bg-white dashboard-crm-box-shadow p-6 rounded-lg">
        <p className="text-gray-500 flex items-center space-x-2">
        ...
        <h2 className="text-2xl font-bold mt-2">8h 10m</h2>
        <p className="text-gray-400 text-sm">This Week: 40h 25m</p>
      </div>
      ...
      <div className="bg-white dashboard-crm-box-shadow p-6 rounded-lg">
        ...
        <p className="text-gray-400 text-sm">Attendance approved for 25 Aug</p>
      </div>
    </div>
  </div>

  {/* <!-- Right Section (Punch History) --> */}
  <div>
    <div className="bg-white dashboard-crm-box-shadow p-6 rounded-lg">
      <p className="text-gray-500 flex items-center space-x-2">
        <svg
        ...
        <span className="font-semibold">Punch History</span>
      </p>
      <ul className="mt-3 text-sm text-gray-600 space-y-2">
        <li>25 Aug → Present (9h 05m)</li>
        <li>24 Aug → Present (8h 55m)</li>
        <li>23 Aug → Absent</li>
        <li>22 Aug → Present (8h 30m)</li>
      </ul>
    </div>
  </div>
       </div>
