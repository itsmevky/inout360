...
const Sidebar = ({ isCollapsed, setIsCollapsed }) => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      links: [
        { label: "Marks", path: "/dashboard/Examination/Marks" },
      ...
      links: [
        {
          ...
          path: "/dashboard/Accounting/StudentFeeManager",
        }, 
      ],
    },
   
    {
      ...
      links: [
        { label: "Library", path: "/dashboard/BackOffice/library/Book list manager" },
        { label: "Booklistmanager", path: "/dashboard/BackOffice/library/Booklistmanager" },
        { label: "Bookissuereport", path: "/dashboard/BackOffice/library/Bookissuereport" },
      ],
...

    {
      ...
      icon: (
        <svg fill="white" width="17" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
      ...
      links: [{ label: "OnlineCourses", path: "/dashboard/OnlineCourses" }],
    },
    {
      label: "My assignment",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="17" viewBox="0 0 448 512">
          <path d="M96 0C43 0 0 43 0 96L0 416c0 53
         43 96 96 96l288 0 32 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l0-64c17.7 0 32-14.3 
         32-32l0-320c0-17.7-14.3-32-32-32L384 0 96 0zm0 384l256 0 0 64L96 448c-17.7 0-32-14
         .3-32-32s14.3-32 32-32zm32-240c0-8.8 7.2-16 16-16l192 0c8.8 0 16 7.2 16 16s-7.2 16-16 
         16l-192 0c-8.8 0-16-7.2-16-16zm16 48l192 0c8.8 0 16 7.2 16 16s-7.2 16-16 16l-192 0c-8.8
          0-16-7.2-16-16s7.2-16 16-16z"/></svg>
      ),
      links: [{ label: "Myassignment", path: "/dashboard/Myassignment" }],
    },
