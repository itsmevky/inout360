...
import EditUserForm from "../../Users/Edit.js";
...
const Rooms = () => {
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      let url;
      let responseData = await API.getRooms(reqPage, rowsPerPage);
      if (searchTerm) {
      ...
      if (responseData && responseData.data) {
        const updatedRooms = responseData.data.map((room) => {
        ...
        console.log("Filtered rooms (excluding super_admin):", updatedRooms);
  ...
  return (
    <div className="relative p-4">
      <div className="list-user-title ">
        <h2 className="text-xl font-bold sub-title">List of Rooms</h2>
      </div>
